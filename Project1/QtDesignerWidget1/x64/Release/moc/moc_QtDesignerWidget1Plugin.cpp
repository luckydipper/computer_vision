...
struct qt_meta_stringdata_QtDesignerWidget1Plugin_t {
    const uint offsetsAndSize[2];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_QtDesignerWidget1Plugin_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_QtDesignerWidget1Plugin_t qt_meta_stringdata_QtDesignerWidget1Plugin = {
    {
...
static const uint qt_meta_data_QtDesignerWidget1Plugin[] = {
...
const QMetaObject QtDesignerWidget1Plugin::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_QtDesignerWidget1Plugin.offsetsAndSize,
    qt_meta_data_QtDesignerWidget1Plugin,
    qt_static_metacall,
    nullptr,
    nullptr,
    nullptr
...
void *QtDesignerWidget1Plugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtDesignerWidget1Plugin.stringdata0))
...
static constexpr unsigned char qt_pluginMetaData_QtDesignerWidget1Plugin[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
